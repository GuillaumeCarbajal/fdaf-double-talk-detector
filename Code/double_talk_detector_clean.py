...
def main():
    signal_microphone, fe = sf.read(
        "629e8071a8fce5001f505436/629e8071a8fce5001f505436_0_1919_1919-142785_external.wav"
    )
    signal_loudspeaker, fe = sf.read(
        "629e8071a8fce5001f505436/629e8071a8fce5001f505436_0_1919_1919-142785_internal.wav"
    )
    N = 512

    dtd_benesty = BenestyCoherenceDoubleTalkDetector(block_length=N, lambda_coherence=0.9)
